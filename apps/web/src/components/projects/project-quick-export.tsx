 ...
 */
export function ProjectQuickExport({
  projectId,
  projectName
}: ProjectQuickExportProps) {
  ...
  return (
    <section className="asset-details project-quick-export">
      ...
      <p className="muted">
        Export consigliati pronti all'uso, un clic e li scarichi.
      </p>
...
function buildDownloadName(
  ...
  const extension =
    format === "session-pack" || format === "foundry"
      ? "zip"
      : format === "dmimap"
        ? "dmimap.json"
        : format;
