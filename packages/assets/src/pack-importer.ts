...
const FORGOTTEN_ADVENTURES_RULES: PackRule[] = [
  {
    classification: "wall",
    pattern: /\bwalls?\b/iu,
    tags: ["forgotten-adventures", "walls"]
  },
  {
    classification: "floor",
    pattern: /\bfloors?\b/iu,
    tags: ["forgotten-adventures", "floors"]
  },
  {
    classification: "furniture",
    pattern: /\bfurniture\b/iu,
    tags: ["forgotten-adventures", "furniture"]
  },
  {
    classification: "prop",
    pattern: /\bprops?\b/iu,
    tags: ["forgotten-adventures", "props"]
  },
  {
    classification: "decoration",
    pattern: /\bdecorations?\b/iu,
    tags: ["forgotten-adventures", "decoration"]
  },
  {
    classification: "light",
    pattern: /\b(lights?|torch|candle|brazier)\b/iu,
    tags: ["forgotten-adventures", "lighting"]
  },
  {
    classification: "terrain",
    pattern: /\b(nature|trees?|rocks?|terrain)\b/iu,
    tags: ["forgotten-adventures", "terrain"]
  },
  {
    classification: "water",
    pattern: /\b(water|river|lake|pond)\b/iu,
    tags: ["forgotten-adventures", "water"]
  },
  {
    pattern: /\b(dungeon|crypt|cave)\b/iu,
    tags: ["forgotten-adventures", "dungeon"]
  },
  {
    pattern: /\b(forest|outdoor|wilderness)\b/iu,
    tags: ["forgotten-adventures", "outdoor"]
  }
];
...
const TWO_MINUTE_TABLETOP_RULES: PackRule[] = [
  {
    classification: "floor",
    pattern: /\btiles?\b/iu,
    tags: ["2-minute-tabletop", "tile-set"]
  },
  {
    classification: "floor",
    pattern: /\bbattle[-_ ]?map\b/iu,
    tags: ["2-minute-tabletop", "battle-map"]
  },
  {
    classification: "wall",
    pattern: /\bwalls?\b/iu,
    tags: ["2-minute-tabletop", "walls"]
  },
  {
    classification: "prop",
    pattern: /\bprops?\b/iu,
    tags: ["2-minute-tabletop", "props"]
  },
  {
    classification: "terrain",
    pattern: /\b(forest|nature|terrain)\b/iu,
    tags: ["2-minute-tabletop", "terrain"]
  },
  {
    pattern: /\b(tavern|inn)\b/iu,
    tags: ["2-minute-tabletop", "interior", "tavern"]
  },
  {
    pattern: /\b(temple|chapel|cathedral)\b/iu,
    tags: ["2-minute-tabletop", "sacred"]
  }
];
...
const CZEPEKU_RULES: PackRule[] = [
  {
    classification: "floor",
    pattern: /\b(map|scene)\b/iu,
    tags: ["czepeku", "full-scene"]
  },
...
export async function importAssetPack(
  ...
  const enrichment = enrichManifestWithPackRules(
    manifest,
    options.preset,
    options.defaultTags ?? []
  );
